...
|---|---|---|
| `GH_ZERO_DECODE_MMVQ=1` | decode 5,55 → 5,62 tok/s (+1,3%) | scartato: guadagno sotto il 3% |
...
Passano le suite complete `gh_zero_engine` Vulkan standalone (135 test unitari),
