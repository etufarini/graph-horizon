...
- `family/mistral/detect.rs`: gate architettura/profilo/capacità.
...
- `family/mistral/tensors.rs`: nomi, shape e dtype ammessi.
- `family/mistral/tokenizer/profile.rs`: selezione privata della sola policy
  chat da `general.name`, senza autenticare il GGUF.
...
- `gguf/`: parsing limitato, metadati e indice tensoriale; non alloca backend.
