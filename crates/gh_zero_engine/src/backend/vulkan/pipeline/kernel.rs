/*
 * gh_zero_engine — Vulkan pipeline specification table
...
pub(super) fn spec(kernel: Kernel) -> (&'static [u8], u32, u32) {
    ...
    match kernel {
        ...
        Kernel::MatmulQ8 => (spv!("matmul_q8_0"), 3, 8),
        ...
        Kernel::LogitsQ8 => (spv!("logits_q8_0"), 3, 8),
        ...
        Kernel::EmbedQ8 => (spv!("embed_q8_0"), 2, 8),
