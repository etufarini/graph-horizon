...
profile, the fixed internal Reasoning instruction is always rendered first.
Non-empty content from an initial `System` message follows it after a blank
line; an empty message adds nothing. Caller-provided content is ordinary
