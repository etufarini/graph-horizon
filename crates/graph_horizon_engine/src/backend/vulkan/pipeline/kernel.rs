...
pub(crate) enum Kernel {
    ...
    AttentionPrefillGqaSplit,
    AttentionPrefillGqaReduce,
...
pub(super) fn spec(kernel: Kernel) -> (&'static [u8], u32, u32) {
    ...
    match kernel {
        ...
        Kernel::AttentionPrefillGqaSplit => (spv!("attention_prefill_gqa_split"), 5, 32),
        Kernel::AttentionPrefillGqaReduce => (spv!("attention_prefill_gqa_reduce"), 3, 32),
