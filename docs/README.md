...
| [prefill-short-context-investigation.md](prefill-short-context-investigation.md) | Phase 5--8 Vulkan prefill attribution, ceiling verification, and retained optimizations |
