...
| [prefill-short-context-investigation.md](prefill-short-context-investigation.md) | Phase 5--6 Vulkan short-context prefill attribution and retained optimizations |
