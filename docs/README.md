...
| [prefill-short-context-investigation.md](prefill-short-context-investigation.md) | Phase 5--7 Vulkan short-context prefill attribution and retained optimizations |
