...
| `--max-tokens <n>` | TUI `2048`; server `1024`; Web `4096` | Response maximum and client admission reserve, integer `>= 0` |
...
with every chat request. The default is `4096`; an explicit `--max-tokens`
