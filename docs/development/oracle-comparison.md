...
Current qualification results belong in [the validation register](../project-status/validation-evidence.md). The
broader release workflow is defined in
[model-support validation](model-support-validation.md).
