...
- NVIDIA Vulkan validation GPU 12 GiB, driver 595.84, Vulkan 1.4.329.
...
|---|---|---|---|---|---|
| Vulkan-hybrid, 100% GPU | Linux x86_64 / NVIDIA Vulkan validation GPU | PASS | PASS | five artifacts PASS | SUPPORTED |
| CPU | Linux x86_64 / i5-9600K | PASS | synthetic PASS | real matrix incomplete | EXPERIMENTAL |
| Vulkan standalone | Linux x86_64 / NVIDIA Vulkan validation GPU | PASS | backend tests PASS | real matrix incomplete | EXPERIMENTAL |
...
verification`, `0 failure`, plus `6/6` semantic qualification. Later Apple
silicon evidence qualifies the documented Metal and Metal-hybrid tuple. Missing
Q8 artifacts and unmeasured devices remain external rather than PASS. The
current summary is [`validation-evidence.md`](validation-evidence.md).
...
Core i5-9600K, NVIDIA Vulkan validation GPU 12 GiB, driver 595.84/Vulkan 1.4.329, Rust/Cargo
