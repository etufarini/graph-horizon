#!/usr/bin/env bash
#
# Remote acquisition boundary: downloads and authenticates the v0.1.1 source
...
release_url="https://github.com/etufarini/graph-horizon/releases/download/v0.1.1"
archive_name="graph-horizon-0.1.1.tar.gz"
archive_url="${release_url}/${archive_name}"
checksum_url="${release_url}/${archive_name}.sha256"
expected_root="graph-horizon-0.1.1"
temp_dir=""
