/*
 * Graph Orizon CLI Modules - Plugins - Command - Completion
...
use crate::graph_orizon_cli::plugins::attachments::{self, FileAuthority};
use crate::graph_orizon_cli::plugins::completion::completion_tail;
