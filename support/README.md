...
| Script | Scopo |
|---|---|
| `../install.sh` | scarica e valida un archivio temporaneo del tag `v0.1.0`, poi delega gli argomenti invariati |
...
repository sarà pubblico. Scarica il tag immutabile `v0.1.0`; il digest
dell'archivio sorgente è pubblicato nel report di qualifica della release:
