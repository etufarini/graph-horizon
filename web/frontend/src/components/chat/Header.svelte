...
<style lang="scss">
  header { min-width: 0; display: grid; gap: var(--gn-space-xs); border-bottom: var(--gn-rule-width) solid var(--gn-border-subtle); padding-bottom: var(--gn-space-sm); }
  ...
  h1 span { font-family: var(--gn-font-mono); font-weight: 750; letter-spacing: 0.06em; }
  h1 small { color: var(--gn-text-muted); font-size: var(--gn-text-xs); font-weight: 500; }
  nav { display: flex; gap: var(--gn-space-xs); }
  button { min-height: var(--gn-control-height); border: var(--gn-rule-width) solid var(--gn-border); border-radius: var(--gn-radius-sm); background: var(--gn-bg-panel); padding: var(--gn-space-xs) var(--gn-space-sm); color: var(--gn-text-primary); cursor: pointer; font: 650 var(--gn-text-xs) var(--gn-font-sans); }
  button span { min-width: 1.4em; display: inline-block; margin-left: 2px; border-radius: 999px; background: var(--gn-bg-panel-raised); color: var(--gn-text-muted); text-align: center; }
